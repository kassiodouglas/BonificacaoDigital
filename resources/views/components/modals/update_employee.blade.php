<div class="modal fade" id="modal_update_employee{{$user->id}}" tabindex="-1" aria-labelledby="modal_update_employee{{$user->id}}" aria-hidden="true">

    <form action="{{route('update.user',['id'=>$user->id])}}" method="POST" onsubmit="updateEmployee(event)">

        <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title">Atualizar funcionário - {{$user->name}}</h5>
